...
public enum JavaPHConstants
{
	...
	public static final String SERVER_S = " Server : %s ";
	public static final String PORT_S = " Port : %s ";
	public static final String HELP_CONTENTS = "Help Contents";
	public static final String CLICK_THIS_TO_START_RUNNING_THE_QUERY = "Click this to start running the query.";
	public static final String EITHER_NO_FIELDS_AVAILABLE_OR_NO_FIELDS_SELECTED_RETURNING_DEFAULT_FIELDS_INSTEAD = "Either no fields available or no fields selected, returning default fields instead";
	public static final String SHOW_HIDE_COLUMNS = "Show/Hide Columns";
	public static final String RESET_COLUMN_WIDTHS = "Reset Column Widths";
	public static final String COLUMN_LIST_FOR_RESULT_TABLE = "Column List for Result Table";
	public static final String SELECT_THE_COLUMNS_TO_BE_DISPLAYED = "Select the columns to be displayed";
	public static final String CLEAR_LOG = "Clear Log";
	public static final String LOG_CLEARED = "Log cleared";
	public static final String LOOK_AND_FEEL = "Look and Feel";
	public static final String CHANGE_LOOK_AND_FEEL = "Change look and feel";
	public static final String COPIES_THE_SELECTION_AND_PUTS_IT_ON_THE_CLIPBOARD = "Copies the selection and puts it on the clipboard";
	public static final String INSERTS_CLIPBOARD_CONTENTS = "Inserts clipboard contents";
	public static final String CUTS_THE_SELECTION_AND_PUTS_IT_ON_THE_CLIPBOARD = "Cuts the selection and puts it on the clipboard";
	public static final String FINDS_THE_SPECIFIED_TEXT_IN_THE_QUERY_RESULTS = "Finds the specified text in the query results";
	public static final String WINDOW = "Window";
	public static final String SET_VISIBILITY_OF_SYSTEM_LOG = "Set visibility of system log";
	public static final String SET_VISIBILITY_OF_TOOLBAR = "Set visibility of toolbar";
	public static final String SET_ROLLOVER_PROPERTY_OF_TOOLBAR = "Set rollover property of toolbar";
	public static final String NEW_QUERY_REQUESTED_RESULTS_CLEARED = "New query requested, results cleared";
	public static final String SAVE_WINDOW_SIZE_POSITION = "Save Window Size / Position";
	public static final String LOAD_FIELDS_MANUALLY = "Load Fields Manually";
	public static final String LOAD_FIELDS_ON_SELECT = "Load Fields on Select";
	public static final String LOAD_FIELDS_ON_STARTUP_SLOW = "Load Fields on Startup  ( Slow! )";
	public static final String QUERY_RUNTIME_SECONDS = " Query Runtime (Seconds) ";
	public static final String SERVER_OPTIONS = " Server Options ";
	public static final String DEFAULT_SERVER = "Default Server : ";
	public static final String LOAD_FIELDS_FOR_SERVERS_MANUALLY_USING_THE_BUTTON_HERE = "Load fields for servers manually using the button here";
	public static final String LOAD_FIELDS_FOR_SERVERS_ONLY_WHEN_SELECTED_FROM_THE_SERVER_LIST = "Load fields for servers only when selected from the server list";
	public static final String LOAD_FIELDS_FOR_ALL_SERVERS_WHEN_STARTING_THE_APPLICATION = "Load fields for all servers when starting the application";
	public static final String STARTUP_OPTIONS = " Startup Options ";
}
