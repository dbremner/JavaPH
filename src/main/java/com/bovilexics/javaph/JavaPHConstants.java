...
public enum JavaPHConstants
{
	...
	public static final String ARGUMENT_IS_OUT_OF_RANGE = "argument is out of range";
	public static final String NOTHING_TO_SAVE_IN_S_TAB = "Nothing to save in %s tab";
	public static final String ERROR_IOEXCEPTION_RECEIVED_WHEN_TRYING_TO_SAVE_FILE_S = "Error: IOException received when trying to save file %s";
	public static final String ERROR_S = "Error: %s";
	public static final String ROLLOVER_TOOLBAR = "Rollover Toolbar";
	public static final String DISPLAY_TOOLBAR = "Display Toolbar";
	public static final String CHANGE_TO_S_LOOK_AND_FEEL = "Change to %s look and feel";
	public static final String ERROR_IOEXCEPTION_RECEIVED_WHEN_TRYING_TO_OPEN_S = "Error: IOException received when trying to open %s";
	public static final String UNKNOWN_STATE_S = "Unknown State: %s";
	public static final String UNKNOWN = "unknown";
	public static final String OK = "OK";
	public static final String HELP_FILE_PATH = "help/index.html";
	public static final String LINE_WRAP = "Line Wrap";
	public static final String EDIT = "Edit";
	public static final String CUT = "Cut";
	public static final String ERROR_ON_QI_LOGIN_S = "Error on Qi login: %s";
	...
	public static final String SAVE_S = "Save %s";
