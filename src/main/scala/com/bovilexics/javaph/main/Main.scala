...
import com.bovilexics.javaph.qi.{ConnectionFactory, ConnectionFactoryImpl, FieldFactory, FieldFactoryImpl, LineFactory, LineFactoryImpl, QiCommand, QiServerManager, ServerFactory, ServerFactoryImpl, ServerManager}
...
object Main
{
  def main(args: Array[String]): Unit =
  {
    ...
    val commands = QiCommand.commands
